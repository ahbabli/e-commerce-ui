                ...
                <div className="flex gap-8">
                  ...
                  <div className="flex flex-col justify-between">
                    <div className="">
                      ...
                      <p className="">Size:{" "} <span className="uppercase">{item.selectedSize}</span> </p>
        ...
        <div className="w-full lg:w-5/12 shadow-lg border-1 border-gray-100 p-8 rounded-lg flex flex-col gap-8">
          ...
          {activeStep === 1 && (
            <button
              ...
              className="w-full bg-gray-800 transition-all duration-300 hover:bg-gray-900 text-white p-2 rounded-lg cursor-pointer flex items-center justify-center gap-2"
            >
              Continue
